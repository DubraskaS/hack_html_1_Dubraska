...
## NOTA: Todos los hacks fueron realizados en base a una pantalla de 1280x800 px (scrolling, es decir, como si se le hubiera hecho zoom a la imagen vertical de ejemplo de cada hack), no se utilizó media Query, ùnicamente, en general, los features de position, flex y float vistos en clase.
